...
# Run the application (you wish to visualize) in order to generate the noisy result files. Thus change this:
NumMunUnbGeoLoc(1)

# Run utils.Generate_pure_region.py to generate regional_consumption_sums.csv

# Read the CSV files into DataFrames. Change result_df to desired CSV file.
